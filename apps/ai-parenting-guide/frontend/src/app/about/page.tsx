...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      {/* Mission Section */}
      <section className="py-12 sm:py-20 px-4 sm:px-6 bg-white dark:bg-gray-900">
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-[980px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 sm:p-8 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all">
              <div className="w-16 h-16 bg-blue-100 dark:bg-blue-900/30 rounded-xl flex items-center justify-center mb-6 shadow-sm">
                <Lightbulb className="h-8 w-8 text-blue-600 dark:text-blue-400" />
              </div>
              <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-white mb-4 tracking-tight">The Core Concept</h3>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 sm:p-8 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all">
              <div className="w-16 h-16 bg-purple-100 dark:bg-purple-900/30 rounded-xl flex items-center justify-center mb-6 shadow-sm">
                <Heart className="h-8 w-8 text-purple-600 dark:text-purple-400" />
              </div>
              <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-white mb-4 tracking-tight">Why It Matters</h3>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
        ...
        <div className="max-w-[980px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <div 
                key={i} 
                className="bg-white dark:bg-gray-900 rounded-2xl p-6 sm:p-8 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-all"
              >
                ...
                <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-white mb-4 tracking-tight">{audience.title}</h3>
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed">{audience.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-[980px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div 
                key={i} 
                className="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700 hover:shadow-md transition-all"
              >
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 tracking-tight">{value.title}</h3>
          ...
          <div className="space-y-6 sm:space-y-8">
            {[
              ...
              <div key={i} className="flex flex-col sm:flex-row gap-4 sm:gap-6 items-start">
                ...
                <div className="flex-1 bg-gray-50 dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 bg-gradient-to-br from-blue-600 to-purple-600">
        <div className="max-w-[980px] mx-auto text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link 
              href="/register" 
              className="px-8 py-4 bg-white dark:bg-gray-900 text-blue-600 rounded-full font-semibold hover:bg-gray-100 transition-all shadow-lg hover:shadow-xl hover:scale-105 no-underline w-full sm:w-auto text-center"
            >
              Get Started Free
            </Link>
            <Link 
              href="/modules" 
              className="px-8 py-4 border-2 border-white text-white rounded-full font-semibold hover:bg-white dark:bg-gray-900/10 transition-all no-underline w-full sm:w-auto text-center"
            >
              Explore Modules
            </Link>
          </div>
