      ...
      <main className="flex-1">
        <div className="max-w-[980px] mx-auto px-4 sm:px-6 py-12 sm:py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-2xl md:text-3xl text-gray-600 dark:text-gray-300 font-light leading-relaxed max-w-[980px] mx-auto">
              Interactive tools and resources to help you develop, assess, and improve ethical AI systems
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-[980px] mx-auto">
            {tools.map((tool, index) => (
              ...
              >
                ...
                <CardContent className="relative px-8 pb-8">
                  <CardDescription className="text-gray-600 dark:text-gray-300 leading-relaxed text-lg mb-6">
                    {tool.description}
                  </CardDescription>
          ...
          <div className="mt-20 text-center">
            <div className="bg-muted/50 backdrop-blur-xl border border-border/50 rounded-3xl p-12 max-w-[980px] mx-auto">
