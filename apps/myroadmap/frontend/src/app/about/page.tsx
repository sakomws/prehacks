        ...
        <div className="prose dark:prose-invert max-w-none">
          <div className="bg-white dark:bg-gray-800 rounded-lg border p-8 mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-lg">
              MyRoadmap is dedicated to democratizing access to high-quality mentorship and career guidance. 
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border p-8 mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              Founded in 2025, MyRoadmap was born from the recognition that traditional education and 
