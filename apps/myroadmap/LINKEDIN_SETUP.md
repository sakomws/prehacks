...
2. **Create New App**
   ...
   - Fill in the required information:
     - **App name**: MyRoadmap (or your preferred name)
...
2. **Add Redirect URLs**
   ...
   - Add: `http://localhost:8002/api/auth/linkedin/callback`
...
export LINKEDIN_REDIRECT_URI="http://localhost:8002/api/auth/linkedin/callback"
```
...
$env:LINKEDIN_REDIRECT_URI="http://localhost:8002/api/auth/linkedin/callback"
```
...
1. **Check LinkedIn redirect**
   ```bash
   curl -L http://localhost:8002/api/auth/linkedin
   ```
...
**Initiate OAuth:**
```
GET http://localhost:8002/api/auth/linkedin
```

**OAuth Callback:**
```
GET http://localhost:8002/api/auth/linkedin/callback?code=<auth_code>
```
...
- Contact support at support@myroadmap.com
- Review the [API Documentation](http://localhost:8002/docs)
