"""
Browser management utilities using Selenium.
"""
...
class BrowserManager:
    ...
    def get_element_text(self, element: Any) -> Optional[str]:
        ...
        try:
            ...
            self.logger.error(f"Failed to get element text: {e}")
            return None
    ...
    def get_element_attribute(self, element: Any, attribute: str) -> Optional[str]:
        ...
        try:
            ...
            self.logger.error(f"Failed to get element attribute '{attribute}': {e}")
            return None
