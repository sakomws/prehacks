...
**Your App Files:**
- Config: `apps/mentormap/backend/.env`
- OAuth Code: `apps/mentormap/backend/app/api/auth.py`
- Login Page: `apps/mentormap/frontend/src/app/login/page.tsx`
...
→ Add `http://localhost:8000/api/auth/linkedin/callback` to LinkedIn app
