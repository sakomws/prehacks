  ...
  const faqs = [
    {
      ...
      questions: [
        {
          q: "What is MentorMap?",
          a: "MentorMap is a mentorship platform connecting students with experienced professionals for 1:1 coaching sessions, personalized learning paths, and career guidance.",
        },
        {
      ...
      questions: [
        {
          ...
          a: "Pricing is $100 per session. Packages available: Single session ($100), 3 sessions ($300), and 6 sessions ($600).",
        },
        {
